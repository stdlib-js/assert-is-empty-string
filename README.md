...
```javascript
import isEmptyString from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-empty-string@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-empty-string@v0.1.1-deno/mod.js';
```
